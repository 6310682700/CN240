...
# python blur_detection.py -i images -t 5 //5 is for threshold
...
images = [cv2.imread(file) for file in glob.glob("/Users/Allumile/Desktop/facial_expression/images/*.jpg".format(args['images']))]
